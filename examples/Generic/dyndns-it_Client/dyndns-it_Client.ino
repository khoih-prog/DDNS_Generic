...
void setup()
{
  ...
  Serial.print("\nStart dyndns-it_Client on " + String(BOARD_NAME));
  ...
  DDNSGeneric.service("dyndns.it");    // Enter your DDNS Service Name - "dyndns.it" / "freemyip" / "duckdns" / "noip"
