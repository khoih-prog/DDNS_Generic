...
void setup()
{
  ...
  Serial.print("\nStart afraid-org_Client on " + String(BOARD_NAME));
  ...
  DDNSGeneric.service("afraid.org");    // Enter your DDNS Service Name - "afraid.org" / "duckdns" / "noip"

  /*
    For DDNS Providers where you get a token:
    DDNSGeneric.client("domain", "token");

    For DDNS Providers where you get a username:
    DDNSGeneric.client("domain", "username");

    For DDNS Providers where you get username and password: ( Leave the password field empty "" if not required )
    DDNSGeneric.client("domain", "username", "password");
  */
  DDNSGeneric.client("hostname.afraid.org", "username");
