...
void setup()
{
  ...
  Serial.print("\nStart freemyip_Client on " + String(BOARD_NAME));
  ...
  DDNSGeneric.service("freemyip");    // Enter your DDNS Service Name - "freemyip" / "duckdns" / "noip"
  ...
  */
  DDNSGeneric.client("account.freemyip.com", "username", "password");
