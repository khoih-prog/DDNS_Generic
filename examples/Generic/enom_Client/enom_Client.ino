...
void setup()
{
  ...
  Serial.print("\nStart enom_Client on " + String(BOARD_NAME));
  ...
  DDNSGeneric.service("enom");

  DDNSGeneric.client("www","example.com","password");    // Enter ddns host & domain name & Password | Example - "www","example.com", "password"
}
